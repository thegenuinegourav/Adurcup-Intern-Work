...
public class CookieController implements CookieStore {

    private final static String PREF_DEFAULT_STRING = "";

    private final static String PREFS_NAME = CookieController.class.getName();
    ...
    public CookieController(Context context) {
